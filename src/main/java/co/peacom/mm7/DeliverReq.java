...
/**
 * Delivery-Request-messaging controls the transfer of an MM from the MMSC to a VASP for
 * processing. For example, when a mobile sends an MM message to a VAS-application, the
 * MM is transferred by the MMSC to the VAS via an MM7_deliver.REQ message.
 * For detailed information, see [3GPP 23.140] paragraph 8.7.2
 */
